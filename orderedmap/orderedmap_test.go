...
func TestNewOrderedMap(t *testing.T) {
	om := NewOrderedMap(100)
	if err := om.Set(5, 33); err != nil {
		t.Error("Unexpected error: ", err)
	}
	if err := om.Set(6, 44); err != nil {
		t.Error("Unexpected error: ", err)
	}
...
func TestMapSize(t *testing.T) {
	...
	if err := om.Set("four", 4); err != ErrFull {
		t.Error("Expected a full map")
	}

	// Pop last and try again
	...
	//
	if err := om.Set("five", 4); err != ErrFull {
		t.Error("Expected a full map")
	}
}
